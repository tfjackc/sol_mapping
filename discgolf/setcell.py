...
@solara.component
def Page():
    column, set_column = use_state(cast(Optional[str], None))
    cell, set_cell = use_state(cast(Dict[str, Any], {}))
    ...
    column_actions = [ColumnAction(icon="mdi-sunglasses", name="User column action", on_click=on_action_column)]
    cell_actions = [CellAction(icon="mdi-white-balance-sunny", name="User cell action", on_click=on_action_cell)]
    solara.Markdown(
        f"""
        ## Demo
